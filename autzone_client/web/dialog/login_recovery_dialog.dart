...
class LoginRecoveryDialog extends DialogBox {
  ...
  Future build() async {
    ...
    InputElement nickInput =
        form.addInput('Nickname', typicalControlWidth(), 40, _nick ?? '');
    if (_nick != null) nickInput.disabled = true;
    form.addExplanation(nickInput,
        'An email has been sent to you. Leave this open, but go check your email and note the code given in the email. Then copy the code below.');
    ...
    bar.addButton('Recover', (e) async {
      //validate
      String pw1 = trimInput(pw1Input),
          pw2 = trimInput(pw2Input),
          code = trimInput(codeInput),
      ...
      UserRecoverPasswordRequest args = new UserRecoverPasswordRequest(
          recoveryNick: nick, recoveryPassword: pw1, code: code, mode: 'V');
