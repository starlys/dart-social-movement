define(['dart_sdk', 'packages/models/models', 'packages/models/wlib'], function(dart_sdk, models, wlib) {
  ...
  let IterableOfEventGetUserResponse = () => (IterableOfEventGetUserResponse = dart.constFn(core.Iterable$(src__models__wtypes.EventGetUserResponse)))();
  ...
  let ListOfResourceItem = () => (ListOfResourceItem = dart.constFn(core.List$(src__models__wtypes.ResourceItem)))();
  ...
  let _ProjectUserItemTobool = () => (_ProjectUserItemTobool = dart.constFn(dart.fnType(core.bool, [src__models__wtypes._ProjectUserItem])))();
  ...
  lib__html_lib.HtmlLib = class HtmlLib extends core.Object {
    ...
    static textAreaValueToLines(el, opts) {
      ...
      let lines = IterableOfString()._check(el.value[$split]("\n")[$map](core.String, dart.fn(s => s[$replaceAll]("\r", ""), StringToString())))[$toList]();
      if (dart.test(removeBlanks)) {
        lines = lines[$map](dart.dynamic, dart.fn(o => dart.dsend(o, 'trim', []), dynamicTodynamic()))[$where](dart.fn(o => core.bool._check(dart.dsend(dart.dload(o, 'length'), '>', [0])), dynamicTobool()))[$toList]();
      }
      return ListOfString()._check(lines);
    }
  ...
  dart.setFieldSignature(lib__outline_builder.OutlineBuilder, () => ({
    ...
    [_parent$]: dart.fieldType(html.Element),
    [_selectHandler]: dart.fieldType(dynamicToFuture())
  }));
  ...
  pane__base_pane.BasePane = class BasePane extends core.Object {
    ...
    buildSkeletonHtml2(opts) {
      ...
      this.paneMenuBar.addElement(paneClose);
      ...
      paneClose[$onClick].listen(dart.fn(e => {
  ...
  pane__user_pane.UserPane = class UserPane extends pane__base_pane.BasePane {
    init(pk) {
      return async.async(dart.dynamic, (function* init$() {
        ...
        build1AssocSection("Events attending", ListOfAPIResponseAssociation()._check(user.events), "paneevent");
        build1AssocSection("Projects", ListOfAPIResponseAssociation()._check(user.projects), "paneproject");
        build1AssocSection("Resources submitted", ListOfAPIResponseAssociation()._check(user.resources), "paneresource");
        if (loggedIn && root__globals.Globals.nick == user.nick) {
  ...
  pane__event_pane.EventPane = class EventPane extends pane__base_pane.BasePane {
    init(pk) {
      return async.async(dart.dynamic, (function* init() {
        ...
        if (loggedIn) {
          let myselfs = IterableOfEventGetUserResponse()._check(event.users[$where](dart.fn(u => u.userId == root__globals.Globals.userId, _EventGetUserResponseTobool())));
  ...
  main_controller.MainController = class MainController extends core.Object {
    static startApp() {
      return async.async(dart.dynamic, function* startApp() {
        ...
        if (dart.test(root__globals.Globals.isLargeScreen)) {
    ...
    static sizeEverything() {
      let delayed = () => {
        ...
        $("#popupconnector").style[$bottom] = lib__html_lib.HtmlLib.asPx(dart.asInt(dart.notNull(wh) - dart.notNull(btnrect[$top]) - 1));
        if (modeChanged) {
    ...
    static showMenu(opts) {
      ...
      main_controller.MainController.hideMenuPanels();
      if (dart.test(allowHide) && dart.test(wasShowing)) return;
      html.querySelector("#menu1").style[$visibility] = "visible";
    ...
    static _showPopupConnector(over) {
      ...
      _[$display] = "block";
      _[$width] = lib__html_lib.HtmlLib.asPx(dart.asInt(dart.notNull(btnrect[$width]) - 2));
      _[$left] = lib__html_lib.HtmlLib.asPx(dart.asInt(btnrect[$left]));
    }
  ...
  pane__proposal_pane.ProposalPane = class ProposalPane extends pane__base_pane.BasePane {
    ...
    [_handleVote$0](optionNo) {
      return async.async(dart.dynamic, (function* _handleVote() {
        ...
        yield rpc_lib.RpcLib.proposalUserSave(req);
        messages.Messages.timed("We recorded your vote.");
      }).bind(this));
    }
    [init$4](pk) {
      return super.init(pk);
  ...
  pane__base_tree_pane.BaseTreePane = class BaseTreePane extends pane__base_pane.BasePane {
    ...
    init(pk) {
      return async.async(dart.dynamic, (function* init() {
        ...
        this[_allCats] = ListOfCategoryItemResponse()._check(cats.categories);
        ...
        for (let node of this[_topCats])
          buildRecur(node);
        this.clearLoadingMessage();
        let outline = new lib__outline_builder.OutlineBuilder.new(this.bodyElement, dynamicToFuture()._check(dart.bind(this, _nodeSelectHandler)));
        function addToOutlineRecur(parentElement, node, level) {
          let el = outline.add(parentElement, node.title, dart.toString(node.id), {childrenCollapsed: dart.notNull(level) > 1});
          if (node.children != null) {
            for (let cnode of node.children)
    ...
    [_nodeSelectHandler](node) {
      return async.async(dart.dynamic, (function* _nodeSelectHandler() {
        ...
        if (dart.test(root__globals.Globals.isSiteAdmin)) {
          bar.addButton("Delete Category", dynamicToFuture()._check(dart.bind(this, 'deleteCategoryHandler')));
          bar.addButton("Create Category", dynamicToFuture()._check(dart.bind(this, 'createCategoryHandler')));
          bar.addButton("Edit Category", dynamicToFuture()._check(dart.bind(this, 'editCategoryHandler')));
          bar.addButton("Move Category", dynamicToFuture()._check(dart.bind(this, 'moveCategoryHandler')));
          bar.addButton("Recategorize Contents", dynamicToFuture()._check(dart.bind(this, 'moveContentsHandler')));
        }
      }).bind(this));
    }
  ...
  dart.setMethodSignature(pane__base_tree_pane.BaseTreePane, () => ({
    ...
    [_nodeSelectHandler]: dart.fnType(async.Future, [html.Element]),
    ...
    deleteCategoryHandler: dart.fnType(async.Future, [html.MouseEvent]),
    createCategoryHandler: dart.fnType(async.Future, [html.MouseEvent]),
    editCategoryHandler: dart.fnType(async.Future, [html.MouseEvent]),
    moveCategoryHandler: dart.fnType(async.Future, [html.MouseEvent]),
    moveContentsHandler: dart.fnType(async.Future, [html.MouseEvent]),
  ...
  pane__resource_tree_pane.ResourceTreePane = class ResourceTreePane extends pane__base_tree_pane.BaseTreePane {
    ...
    getContentIds(contentTitles) {
      return IterableOfint()._check(contentTitles[$map](core.int, dart.fn(s => {
        let matches = ListOfResourceItem()._check(this[_resources].items[$where](dart.fn(i => i.title == s, _ResourceItemTobool()))[$toList]());
    ...
    [_doSearch$0]() {
      return async.async(dart.dynamic, (function* _doSearch() {
        ...
        for (let conv of response.convs) {
          src__models__wtypes.ConvQueryConvItemResponse._check(conv);
          let itemDiv = html.DivElement.new();
          itemDiv.className = "space1";
          ...
          for (let post of conv.posts) {
            src__models__wtypes.ConvQueryPostItemResponse._check(post);
            indented[$appendText](post.hitText);
            indented[$appendHtml]("<br/>");
          }
        }
        if (response.convs[$length] === 0) this[_resultDiv$0][$innerHtml] = "(none)";
      }).bind(this));
    }
    [init$11](pk) {
      return super.init(pk);
  ...
  pane__project_members_pane.ProjectMembersPane = class ProjectMembersPane extends pane__base_pane.BasePane {
    ...
    [_doSearch$1](name) {
      return async.async(dart.dynamic, (function* _doSearch() {
        ...
        if (this[_project] != null && this[_project].completeLoad === "Y") {
          this[_filteredUsers] = ListOfProjectUserItem()._check(this[_project].users[$where](dart.fn(u => u.nick[$toLowerCase]()[$contains](name) || u.publicName[$toLowerCase]()[$contains](name), _ProjectUserItemTobool()))[$toList]());
        } else {
          this[_pageNo] = 0;
    ...
    [_loadProject](nameFilter) {
      return async.async(dart.dynamic, (function* _loadProject() {
        ...
        this[_filteredUsers] = ListOfProjectUserItem()._check(this[_project].users);
  ...
  rpc_lib.RpcLib = class RpcLib extends core.Object {
    static init() {
      if (html.window[$location].protocol === "file:")
        rpc_lib.RpcLib.serverBaseUrl = "http://localhost:8083/servant/v2/";
      else
    ...
    static rpcAsMap(method, requestMap) {
      return async.async(MapOfString$dynamic(), function* rpcAsMap() {
        ...
        let hreq = (yield html.HttpRequest.request(url, {method: "POST", responseType: "json", requestHeaders: requestHeaders, sendData: requestJson}));
    ...
    static authenticate(req) {
      return async.async(src__models__wtypes.AuthenticateResponse, function* authenticate() {
        ...
        let responseMap = (yield rpc_lib.RpcLib.rpcAsMap("Authenticate", requestMap));
    ...
    static _timerTick() {
      return async.async(dart.dynamic, function* _timerTick() {
        ...
        if (pollNow && root__globals.Globals.nick != null) {
          ...
          let items = push_queue_handler.PushQueueHandler._filterListOfItems(ListOfPushQueueItem()._check(pushQueueResponse.items));
  ...
  pane_factory.PaneFactory = class PaneFactory extends core.Object {
    ...
    static create(pk, opts) {
      return async.async(pane__base_pane.BasePane, function* create() {
        ...
        while (dart.notNull(root__globals.Globals.panes[$length]) > 5000)
        ...
        let goSmoothScroll = () => {
          main1[$animate](JSArrayOfMapOfString$dynamic().of([new (IdentityMapOfString$dynamic()).from(["scrollTop", priorScrollHeight + 30])]), new (IdentityMapOfString$Object()).from(["duration", 500, "fill", "forwards"]));
        };
    ...
    static delete(p) {
      ...
      try {
        ...
        if (isLast)
          ...
          let effect = p.borderElement[$animate](JSArrayOfMapOfString$dynamic().of([new (IdentityMapOfString$dynamic()).from(["height", 0, "margin-top", 0, "margin-bottom", 0])]), new (IdentityMapOfString$Object()).from(["duration", 300, "fill", "forwards"]));
