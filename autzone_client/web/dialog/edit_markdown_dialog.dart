...
class EditMarkdownDialog extends DialogBox {
  ...
  Future build() async {
    ...
    frame.appendHtml(
        '<div class="explain">This site uses <a target="_blank" href="https://gist.github.com/budparr/9257428">Markdown</a> for editing.</div>',
    ...
    frame.append(new DivElement()
      ..id = 'wmd-preview' + _idSuffix); //maybe put this in separate tab?
  }
